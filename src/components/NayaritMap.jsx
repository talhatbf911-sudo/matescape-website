      ...
      <div className={styles.inner}>
        <div className={styles.left}>
          ...
          <div className={styles.body}>
            <p>We started in Nayarit, Mexico, hosting our first small-group experiences along the Pacific coast. What began with a few sunset hikes, beach gatherings, and shared dinners quickly showed us how much people were looking for a different way to travel. Travelers joined solo, explored places beyond the usual spots, met others along the way, and often came back for more experiences afterward. Some people ended up joining multiple experiences together. Others kept in touch or crossed paths again later during their travels. Small moments, but exactly the kind of travel experience we wanted to create.</p>
            <p>Now we're taking the next step. Next stop: Oaxaca, Puerto Escondido &amp; Mazunte. A completely different energy... mountains, culture, mezcal, surf towns, and slower rhythms. The same idea. A new setting. And we're already looking beyond: Palenque and, soon after, Guatemala. Our first step outside Mexico.</p>
          </div>
        </div>
